...
```sh
# 提升权限，将test文件的所有者修改为root
sudo chown root test 

# 查看详细信息
ls -l

# 提升权限，将test文件的所属组修改为root
...
# 递归复制study目录并命名为study_copied
cp -r study study_copied
