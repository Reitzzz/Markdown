...
**目录**
- [1. 轻松打包运行](#1-轻松打包运行)
  - [1.1 打包为 Jar 包直接运行](#11-打包为-jar-包直接运行)
  - [1.2 打包为 War 包部署到 Tomcat](#12-打包为-war-包部署到-tomcat)
  - [1.3 编译为 GraalVM 原生镜像运行](#13-编译为-graalvm-原生镜像运行)
