...
这是因为SpringSecurity**自带了csrf防护**，**需求我们在POST请求中携带页面中的csrfToken才可以**，否则一律进行拦截操作，这里我们可以将其嵌入到页面中，随便找一个地方添加以下内容：
