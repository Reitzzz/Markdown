...
- [目录](#目录)
- [1. 基于数据库验证](#1-基于数据库验证)
  - [1.1 数据库表设计与依赖配置](#11-数据库表设计与依赖配置)
  - [1.2 配置类与数据源设置](#12-配置类与数据源设置)
  - [1.3 UserDetailsManager接口与修改密码功能](#13-userdetailsmanager接口与修改密码功能)
...
public class SecurityConfiguration {
    ...
    public DataSource dataSource(){
        ...
        return new PooledDataSource("com.mysql.cj.jdbc.Driver",
                "jdbc:mysql://localhost:3306/test", "root", "123456"); //test指的是database
    }
...
## 1.3 UserDetailsManager接口与修改密码功能
